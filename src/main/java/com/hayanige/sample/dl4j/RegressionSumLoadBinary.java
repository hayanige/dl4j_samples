...
public class RegressionSumLoadBinary {

  private static Logger log = LoggerFactory.getLogger(RegressionSumLoadBinary.class);
  ...
  private static DataSetIterator getTrainingData(int batchSize, Random rand) {
    log.info("***** load binary data *****");

    // load training samples
    DataSet trainings = new DataSet();
    File trainingFile = new File("src/main/resources/sum_training_samples.bin");
    trainings.load(trainingFile);

    // load training labels
    DataSet labels = new DataSet();
    File labelFile = new File("src/main/resources/sum_training_labels.bin");
